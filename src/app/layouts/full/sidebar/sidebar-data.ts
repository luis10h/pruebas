...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    route: '/dashboard/view/form-usuario',
    // chip: true,
    external: true,
    chipClass: 'bg-secondary text-white',
    // chipContent: 'PRO',
  ...
  {
    displayName: 'Tabla de Usuarios',
    iconName: 'mdi:taxi',
    route: '/dashboard/view/tabla-usuarios',
    // chip: true,
    external: true,
    chipClass: 'bg-secondary text-white',
    // chipContent: 'PRO',
  ...
  // {
  //   displayName: 'Seleccionar usuarios',
  //   iconName: 'solar:chat-round-line-line-duotone',
  //   route: '/dashboard/view/listado-usuarios',
  //   // chip: true,
  //   external: true,
  //   chipClass: 'bg-secondary text-white',
  //   // chipContent: 'PRO',
  ...
  // },
  // {
  //   displayName: 'Lista de usuarios 2',
  //   iconName: 'mdi:format-list-bulleted',
  //   route: '/dashboard/view/listado-usuarios',
  //   chip: true,
  //   external: true,
